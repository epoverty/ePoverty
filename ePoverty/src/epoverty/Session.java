...
public class Session
{
    ...
    public static int findAccessType(Person person)
    {
        try
        {
            ...
            if (MySQLInterface.ExecutePreparedStatement(ps)) //Person is admin
            {
            ...
            if (MySQLInterface.ExecutePreparedStatement(ps)) //Person is donor
            {
            ...
            if (MySQLInterface.ExecutePreparedStatement(ps)) //Person is fundraiser
            {
